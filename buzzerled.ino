...
// Sensor frontal (frente) 

const int trigPinFrente = 6;     // Pino TRIG do sensor frontal   

const int echoPinFrente = 7;     // Pino ECHO do sensor frontal   

  

// Sensor traseiro (atrás) 

const int trigPinTras = 10;      // Pino TRIG do sensor traseiro   

const int echoPinTras = 11;      // Pino ECHO do sensor traseiro   
